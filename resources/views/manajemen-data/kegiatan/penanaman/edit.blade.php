        ...
        <div class="row">
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-right">
                    <a href="{{ route('penanaman.index') }}" class="btn btn-warning btn-rounded"><i class="fas fa-angle-left"></i> Kembali</a>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="mt-3 form-horizontal" action="{{ route('penanaman.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    @foreach ($bibit as $bibit)
                                        <option value="{{ $bibit->id }}" {{ $data->bibit_id == $bibit->id ? 'selected' : '' }}>{{ $bibit->bibit }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <img src="{{ asset('images/' . $data->foto) }}" alt="Foto" width="100px" height="100px"><br><br>
                                </div>

                                <input type="hidden" class="form-control" name="inputed_by" value="{{ $data->inputed_by }}">
