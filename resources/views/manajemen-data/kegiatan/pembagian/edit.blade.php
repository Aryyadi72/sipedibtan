    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="mt-3 form-horizontal" action="{{ route('pembagian.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <img src="{{ asset('pembagian/' . $data->foto) }}" alt="Foto" width="100px" height="100px"><br><br>
                                </div>
