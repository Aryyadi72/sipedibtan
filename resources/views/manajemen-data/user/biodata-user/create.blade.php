    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="mt-3 form-horizontal" action="{{ route('pembagian.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                ...
                                <label for="inputHorizontalSuccess" class="col-sm-1 col-form-label">User</label>
                                <div class="col-sm-11">
