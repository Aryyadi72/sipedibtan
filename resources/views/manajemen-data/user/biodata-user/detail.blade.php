                    ...
                    <div class="card-body">
                        <form class="mt-3 form-horizontal" action="{{ route('biodata.update', $data->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="umur" value="{{ $data->umur }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tempat_lahir" value="{{ $data->tempat_lahir }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="tanggal_lahir" value="{{ $data->tanggal_lahir }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="no_ktp" value="{{ $data->no_ktp }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="no_telpon" value="{{ $data->no_telpon }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pendidikan" value="{{ $data->pendidikan }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="agama" value="{{ $data->agama }}" disabled>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="domisili" value="{{ $data->domisili }}" disabled>
                                </div>
